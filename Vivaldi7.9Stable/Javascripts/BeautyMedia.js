          ...
          if (isAudioOn) {
              if (tabPosition) {
                  ...
                  styleTag.textContent = `
                      html.beautymedia-tabs-animation-enabled .tab-position:not(:has(.tab-wrapper)):has([id="tab-${tabId}"].audio-on):not(:has(.active))::before,
                      html.beautymedia-tabs-animation-enabled .tab-position:not(:has(.tab-wrapper)):has([data-id="tab-${tabId}"].audio-on):not(:has(.active))::before,
